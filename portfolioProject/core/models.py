...
class HomePageTitleAndExtra(models.Model):
    ...
    partners = models.PositiveIntegerField(default=0,null=True,blank=True)
    project_done = models.PositiveIntegerField(default=0,null=True,blank=True)
    happy_client = models.PositiveIntegerField(default=0,null=True,blank=True)
